...
def pr():
    ...
    if one_or_more == "Many" or "many":
        times = int(input(" > How many items do you ant to add ? \n > "))
        ...
        if P == "per day" or "Per Day" or "per Day" or "Per day" or "Day" or "day":
            ...
            Wab_to_quit = input(" > Do you want to quit or go back to the main menu ? \n > ")
            if Wab_to_quit == "Yes" or "yes" or True or "Yep" or "yep" or "quit" or "q" or "Quit" or "Q":
                pass
            elif Wab_to_quit == "No" or "no" or "Nope" or False or "nope" or "main menu" or "Main menu" or "main Menu" or "Main Menu":
                main_menu()
            else:
                pass
        ...
        want_to_quit: str = input(" > Do you want to quit or go back to the main menu ? ")
        if want_to_quit == True or "Yes" or "yes" or "Yep" or "yep" or "quit" or "Quit":
            quit()

        elif want_to_quit == False or "No" or "no" or "Nope" or "nope" or "Main menu" or "main menu":
            main_menu()
